<template>
  <!--递归生成树-->
    <el-menu :default-openeds="['/lead1']" class="panel-center-left el-menu-vertical-demo collapse-transition" theme="light" @open="handleOpen" @close="handleClose" unique-opened router>
